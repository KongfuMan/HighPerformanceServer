...
final class ChannelHandlerMask {
     ...
     */
    public static int mask(Class<? extends ChannelHandler> handlerType) {
        int mask = MASK_EXCEPTION_CAUGHT;
        try {
            if (ChannelInboundHandlerAdapter.class.isAssignableFrom(handlerType)) {
            ...
            if (ChannelOutboundHandlerAdapter.class.isAssignableFrom(handlerType)) {
     ...
     * {@link DefaultChannelPipeline} and so <strong>MUST</strong> only be used when the {@link ChannelHandler}
